...
require (
	...
	github.com/substrait-io/substrait-go/v7 v7.2.0 // indirect
...
replace github.com/apache/iceberg-go => github.com/miniohq/iceberg-go v0.0.0-20251229084722-8de9060baa09
